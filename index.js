const  XBOT = 'BABUBOT'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/avn_official.03'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+62895414533737'; // Nomor whatsapplu cok
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/62895414533737' ,MessageType.text);

}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik !help/!info/!donateContoh !help' ,MessageType.text);
}
else if (text == 'Eoy'){
conn.sendMessage(id, 'Ya?, Ketik !help/!info/!donate Contoh !help' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya?, Ketik !help/!info/!donatebContoh !help' ,MessageType.text);
}
...
conn.sendMessage(id, 'Ya?, Ketik !help/.!nfo/!donate Contoh !help' ,MessageType.text);
}
else if (text == 'Cuy'){
conn.sendMessage(id, 'Ya?, Ketik !help/!info/!donatebContoh !help' ,MessageType.text);
}
...
conn.sendMessage(id, help.help(id,  XBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '!donasi'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
