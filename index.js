...
//
const BotName = 'Vian_Bot 🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/avn_official.03'; // Nama Instagramlu cok
const whatsapplu = '+1701 660-7496'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'BLOM BUAT'; // OFFICIAL GRUP LU 1
const grupch2 = 'BLOM BUAT'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Vian_G4nz`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @Vian_G4nz`)
})
