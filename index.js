...
//
const BotName = 'Ru_BOT'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/Kang P Wkwkwk'; // Nama Instagramlu cok
const whatsapplu = 'wa.me/628190828896'; // Nomor whatsapplu cok
const kapanbotaktif = 'TERGANTUNG SINYAL'; // Kapan bot lu aktif
const grupch1 = 'BELOM ADA'; // OFFICIAL GRUP LU 1
const grupch2 = 'BELOM ADA'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
