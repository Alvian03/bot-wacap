...
*/
const XPTN = 'A V N  B O T'; // JANGAN DI UBAH NNTI EROR
const instagram = 'https://instagram.com/avn_official.03'; // JANGAN DI UBAH NNTI EROR
const nomer = 'https://Wa.me/+17016607496'; // JANGAN DI UBAH NANTI EROR
const aktif = 'Sesuai Selera'; // DI GANTI AUTO EROR
const groupwa = 'https://chat.whatsapp.com/EQdRbQOGw6NGCnxZ5QkP8E'; // DI GANTI AUTO EROR
const youtube = 'Gada Tod'; // DI GANTI AUTO EROR
//
...
conn.sendMessage(id, 'group bot https://chat.whatsapp.com/EQdRbQOGw6NGCnxZ5QkP8E' ,MessageType.text);
}
else if (text == '!tools1'){
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan *👾A V N  B O T👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/avn_official.03' ,MessageType.text);
}
else if (text == '!tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan *👾A V N  B O T👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/@avn_official.03' ,MessageType.text);
}
